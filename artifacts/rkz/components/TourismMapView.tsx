/**
 * TourismMapView — Leaflet map showing tourist attractions as emoji pins.
...
<style>
  ...
  .pop-city   { font-size: 11px; color: #D4A843; margin-bottom: 8px; display: flex; align-items: center; gap: 4px; }
...
(function () {
  ...
  var CAT_AR = {
    cultural: 'ثقافي', events: 'فعاليات', nature: 'طبيعة',
    entertainment: 'ترفيه', religious: 'ديني',
  };
  var CAT_EN = {
    cultural: 'Cultural', events: 'Events', nature: 'Nature',
    entertainment: 'Entertainment', religious: 'Religious',
  };

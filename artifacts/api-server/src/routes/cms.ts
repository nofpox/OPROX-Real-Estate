...
const DEFAULT_SITE_CONTENT: Record<SiteSection, unknown> = {
  ...
  about: {
    ...
    body: "Rozoz Smart Solutions is a leading property management company in Saudi Arabia, specializing in hotels, residential compounds, and corporate facilities.",
    imageUrl: "",
  },
  branding: {

...
import rkzAnalysisRouter from "./rkz-analysis";
...
const PUBLIC_PREFIXES = ["/auth/", "/health", "/unit-requests", "/unit-info/", "/service-categories", "/rkz/", "/portal/", "/debug/"];

...
export const ROLES: RoleDefinition[] = [
  ...
  // 2 — Company tier: Corporate-level access
  {
    ...
    allowedNav: ["/", "/properties", "/rooms", "/guest-requests", "/analytics", "/user-management", "/admin-settings", "/content-manager"],
    taskCategories: null,
  },
  ...
  // 4 — Departmental Administrator: Reporting, unit data, operational monitoring
  {
    ...
    allowedNav: ["/", "/properties", "/rooms", "/guest-requests", "/analytics", "/user-management", "/admin-settings", "/activity-log", "/content-manager"],
    taskCategories: null,
  },

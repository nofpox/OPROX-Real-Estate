/**
 * LOCAL DATA STORE — Esteti In PMS Standalone
...
export const STAFF: Staff[] = [
  { id: 1, name: "Nada Yousef", role: "General Manager", systemRole: "manager", email: "nada@estetiин.com", phone: "+966501234567", propertyId: 1, propertyName: "Grand Hotel Downtown", status: "active", invitePending: false, hasAccount: true },
  { id: 2, name: "Sara Al-Qahtani", role: "Front Desk Supervisor", systemRole: "supervisor", email: "sara@estetiин.com", phone: "+966509876543", propertyId: 1, propertyName: "Grand Hotel Downtown", status: "active", invitePending: false, hasAccount: true },
  { id: 3, name: "Khalid Al-Dosari", role: "Maintenance Technician", systemRole: "maintenance", email: "khalid@estetiин.com", phone: "+966512345678", propertyId: 1, propertyName: "Grand Hotel Downtown", status: "active", invitePending: false, hasAccount: true },
  { id: 4, name: "Fatima Al-Zahrani", role: "Housekeeping Supervisor", systemRole: "cleaning", email: "fatima@estetiин.com", phone: "+966521234567", propertyId: 2, propertyName: "Sunset Apartments", status: "active", invitePending: false, hasAccount: true },
  { id: 5, name: "Omar Al-Shehri", role: "Security Officer", systemRole: "security", email: "omar@estetiин.com", phone: "+966531234567", propertyId: 2, propertyName: "Sunset Apartments", status: "active", invitePending: false, hasAccount: true },
  { id: 6, name: "Nadia Al-Otaibi", role: "Property Manager", systemRole: "administrator", email: "nadia@estetiин.com", phone: "+966541234567", propertyId: 3, propertyName: "Oakwood Compound", status: "active", invitePending: false, hasAccount: true },
  { id: 7, name: "Youssef Al-Harbi", role: "HVAC Technician", systemRole: "maintenance", email: "youssef@estetiин.com", phone: "+966551234567", propertyId: 3, propertyName: "Oakwood Compound", status: "active", invitePending: false, hasAccount: true },
  { id: 8, name: "Layla Al-Ghamdi", role: "Receptionist", systemRole: "supervisor", email: "layla@estetiин.com", phone: "+966561234567", propertyId: 1, propertyName: "Grand Hotel Downtown", status: "active", invitePending: false, hasAccount: true },
  { id: 9, name: "Hassan Al-Mutairi", role: "Security Guard", systemRole: "security", email: "hassan@estetiин.com", phone: "+966571234567", propertyId: 2, propertyName: "Sunset Apartments", status: "active", invitePending: false, hasAccount: true },
  { id: 10, name: "Reem Al-Anazi", role: "Cleaning Staff", systemRole: "cleaning", email: "reem@estetiин.com", phone: "+966581234567", propertyId: 3, propertyName: "Oakwood Compound", status: "inactive", invitePending: false, hasAccount: false },
];
...
export const LOCAL_USERS: Record<string, { password: string; user: User }> = {
  superadmin: {
    ...
    user: { id: 0, username: "superadmin", displayName: "Nada Yousef", email: "nada@estetiин.com", role: "super_admin", status: "active", mustChangePassword: false },
  },
  admin: {
    password: "yousef171965",
    user: { id: 1, username: "superadmin", displayName: "Nada Yousef", email: "nada@estetiин.com", role: "super_admin", status: "active", mustChangePassword: false },
  },
  manager: {
    password: "manager123",
    user: { id: 2, username: "manager", displayName: "Sara Al-Qahtani", email: "manager@estetiин.com", role: "owner", status: "active", mustChangePassword: false },
  },
  worker: {
    password: "worker123",
    user: { id: 3, username: "worker", displayName: "Khalid Al-Dosari", email: "worker@estetiин.com", role: "maintenance", status: "active", mustChangePassword: false },
  },
};

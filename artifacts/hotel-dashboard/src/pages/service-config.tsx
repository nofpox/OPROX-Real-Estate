...
import type { ServiceCategory } from "@workspace/api-client-react";
...
export default function ServiceConfig() {
  ...
  const { data: categories = [], isLoading } = useQuery<ServiceCategory[]>({
    ...
    queryFn:  () => fetch("/api/service-categories?all=true").then(r => r.json()),
  });

  const invalidate = () => qc.invalidateQueries({ queryKey: SERVICE_CATEGORIES_QUERY_KEY });

...
const SECTIONS = [
  {
    ...
    body_ar: 'بمجرد قيام المستخدم بالتسجيل في منصة HousIn واستخدامها، فإن ذلك يعد موافقة صريحة على جميع بنود هذه الشروط والأحكام. وفي حال عدم الموافقة، يجب على المستخدم الامتناع عن استخدام المنصة.',
    body_en: 'By registering and using the HousIn platform, the user expressly agrees to all these Terms & Conditions. If you do not agree, you must refrain from using the platform.',
  },
  {
    ar: "طبيعة الخدمة",
    en: "Nature of Service",
    body_ar: "توفر HousIn منصة إلكترونية لإدارة العقارات وتوثيق العقود الإيجارية وإرسال التنبيهات المتعلقة بالدفع. تعمل الشركة كوسيط تقني فقط ولا تتحمل أي مسؤولية قانونية أو تعاقدية تنشأ بين المؤجر والمستأجر أو البائع والمشتري.",
    body_en: "HousIn provides an electronic platform for property management, lease documentation and payment notifications. The company acts as a technology intermediary only and bears no legal or contractual liability arising between landlord and tenant or seller and buyer.",
  },
  {
  ...
  },
  {
    ...
    body_ar: 'جميع الحقوق المتعلقة بمنصة HousIn من تصميم وشفرة برمجية وشعار ومحتوى هي ملك حصري للشركة. يحظر نسخ أو إعادة توزيع أو تعديل أي جزء من المنصة دون الحصول على موافقة خطية مسبقة.',
    body_en: 'All rights relating to the HousIn platform — design, code, logo and content — are the exclusive property of the company. Copying, redistributing or modifying any part of the platform without prior written consent is strictly prohibited.',
  },
  {
...
export const Terms: React.FC = () => {
  ...
  return (
    <>
      <Helmet>
        <title>{isRtl ? 'الشروط والأحكام — HousIn' : 'Terms & Conditions — HousIn'}</title>
      </Helmet>

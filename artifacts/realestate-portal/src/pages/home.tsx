...
export function Home() {
  ...
  return (
    <div className="font-sans">
      ...
      {/* ── Download App ──────────────────────────────────────────────────────── */}
      <section className="py-16 bg-gradient-to-br from-[#0f2040] via-[#132848] to-[#0f2040] overflow-hidden relative">
        {/* decorative circles */}
        <div className="absolute -top-20 -right-20 w-80 h-80 rounded-full bg-[#c9a84c]/10 blur-3xl pointer-events-none" />
            ...
            <div className="flex-1 flex justify-center">
              <div className="relative w-52 h-80 bg-[#0a1628] rounded-[2.5rem] border-4 border-[#c9a84c]/50 shadow-2xl flex flex-col items-center justify-center overflow-hidden">
                ...
                <div className="absolute inset-2 rounded-[2rem] bg-gradient-to-b from-[#0f2040] to-[#1a3060] flex flex-col items-center justify-center gap-3 p-4">
                  ...
                  <div className="w-full bg-white/5 rounded-xl p-2 text-center">
                    <div className="text-white/70 text-xs">ذكاء اصطناعي بعامية سعودية</div>
                  </div>
                </div>
                {/* notch */}
                <div className="absolute top-3 left-1/2 -translate-x-1/2 w-16 h-4 bg-[#0a1628] rounded-full z-10" />
              </div>
            </div>

            {/* Text + buttons */}
            <div className="flex-1 text-center md:text-right" dir={isRtl ? 'rtl' : 'ltr'}>
              <div className="inline-block bg-[#c9a84c]/20 text-[#c9a84c] text-xs font-bold px-3 py-1 rounded-full mb-4">
              ...
              <p className="text-white/60 text-base mb-8 max-w-md mx-auto md:mx-0">
                {isRtl
                  ? 'ابحث عن عقارك المثالي، احجز جولات، وتواصل مع الوكلاء — كل ذلك من راحة هاتفك'
                  : 'Find your dream property, book tours, and connect with agents — all from your phone'}
              </p>

              {/* Store buttons */}
              <div className="flex flex-col sm:flex-row gap-3 justify-center md:justify-start" dir="ltr">
                {/* Google Play */}
                <a
                  href="https://play.google.com/store/apps/details?id=com.housin.app"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-3 bg-white/10 hover:bg-white/20 border border-white/20 hover:border-[#c9a84c]/50 text-white rounded-xl px-5 py-3 transition-all group"
                >
                  <svg className="w-7 h-7 shrink-0" viewBox="0 0 24 24" fill="none">
                    <path d="M3.18 23.4c.36.2.8.2 1.18-.02l11.02-6.36-2.5-2.5L3.18 23.4z" fill="#EA4335"/>
                    <path d="M20.82 10.1c-.48-.28-4.64-2.68-4.64-2.68L13.3 10.3l3 3 4.52-2.6c.66-.38.66-1.22 0-1.6z" fill="#FBBC04"/>
                    <path d="M4.36.62C3.98.4 3.54.4 3.18.62L12.88 10.3l2.5-2.5L4.36.62z" fill="#4285F4"/>
                    <path d="M3.18.62L3.18 23.4l9.7-9.7V10.3L3.18.62z" fill="#34A853"/>
                  </svg>
                  <div className="text-left">
                    <div className="text-[10px] text-white/60 leading-none">{isRtl ? 'متاح على' : 'GET IT ON'}</div>
                ...
                {/* App Store */}
                <a
                  href="https://apps.apple.com/app/housin/id000000000"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-3 bg-white/10 hover:bg-white/20 border border-white/20 hover:border-[#c9a84c]/50 text-white rounded-xl px-5 py-3 transition-all group"
                >
              ...
              {/* rating */}
              <div className="flex items-center gap-2 mt-5 justify-center md:justify-start" dir="ltr">
                <div className="flex text-[#c9a84c] text-sm">★★★★★</div>
                <span className="text-white/50 text-xs">{isRtl ? '4.9 · +50,000 تحميل' : '4.9 · 50K+ Downloads'}</span>
              </div>
            </div>
          </div>
        </div>

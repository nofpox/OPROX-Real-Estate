...
const translations = {
  en: {
    ...
    'footer.description': 'Esteti In Smart Solutions — Focused and precise property management across Saudi Arabia.',
    ...
    // ── Listing detail ───────────────────────────────────────────────────────
    'detail.operationalHeading':       'Under Esteti In Management',
    'detail.operationalText':          'This property is actively managed by Esteti In Smart Solutions. Our team handles operations, staffing, maintenance, and reporting.',
    ...
    'detail.portalPrompt':             'Already a Esteti In client?',
    ...
    'portal.registerSubtitle':        'Join Esteti In to manage your properties and portfolio',
    ...
    'cms.noAnnouncements':  'No announcements yet. Type above and press Add.',
    ...
    'staff.delete':          'Remove Member',
    'staff.confirmDelete':   'This will permanently remove this team member. Continue?',
    'staff.create':          'Add Member',
    'staff.creating':        'Creating...',
    'staff.deleting':        'Removing...',
    'staff.cancel':          'Cancel',
    'staff.usernameTaken':   'Username is already taken. Please choose another.',
    'staff.passwordTooShort':'Password must be at least 8 characters.',
  },
  ...
  ar: {
    ...
    'footer.description': 'استيتي إن للحلول الذكية — إدارة عقارات بتركيز ودقة في جميع أنحاء المملكة.',
    ...
    // ── Listing detail ───────────────────────────────────────────────────────
    'detail.operationalHeading':       'تحت إدارة استيتي إن',
    'detail.operationalText':          'يُدار هذا العقار بفعالية من قبل استيتي إن للحلول الذكية. يتولى فريقنا العمليات، التوظيف، الصيانة، وتقديم التقارير.',
    ...
    'detail.portalPrompt':             'هل أنت عميل لاستيتي إن؟',
    ...
    'portal.registerSubtitle':        'انضم إلى استيتي إن لإدارة عقاراتك ومحفظتك',
    ...
    'cms.subtitle':         'تعديل محتوى الموقع — التغييرات تُنشر فوراً',
    'cms.save':             'حفظ التغييرات',
    'cms.saving':           'جاري الحفظ...',
    'cms.saved':            'تم الحفظ',
    'cms.saveError':        'فشل الحفظ. يرجى المحاولة مجدداً.',
    'cms.branding':         'الهوية',
    'cms.hero':             'القسم الرئيسي',
    'cms.contact':          'معلومات التواصل',
    'cms.about':            'قسم من نحن',
    'cms.cta':              'دعوة للتصرف',
    'cms.footer':           'التذييل',
    ...
    'cms.noAnnouncements':  'لا توجد إعلانات بعد. اكتب النص وانقر إضافة.',
    'cms.announcementsNote':'التغييرات تُحفظ على الخادم — انقر حفظ التغييرات أعلاه.',
    ...
    'cms.field.metaDescription': 'الوصف التعريفي',

    // ── Staff Management ──────────────────────────────────────────────────────
    'staff.title':           'إدارة الموظفين',
    'staff.subtitle':        'إضافة وإدارة والتحكم في وصول أعضاء فريقك',
    'staff.addMember':       'إضافة عضو',
    'staff.addTitle':        'إضافة عضو جديد للفريق',
    'staff.noMembers':       'لا يوجد أعضاء في الفريق.',
    ...
    'staff.delete':          'حذف العضو',
    'staff.confirmDelete':   'سيؤدي هذا إلى حذف هذا العضو نهائياً. هل تريد المتابعة؟',
    'staff.create':          'إضافة عضو',
    'staff.creating':        'جاري الإضافة...',
    'staff.deleting':        'جاري الحذف...',
    'staff.cancel':          'إلغاء',
    'staff.usernameTaken':   'اسم المستخدم مستخدم بالفعل. الرجاء اختيار اسم آخر.',
    'staff.passwordTooShort':'كلمة المرور يجب أن تكون 8 أحرف على الأقل.',
  },
};

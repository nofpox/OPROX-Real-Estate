...
const translations = {
  en: {
    ...
    'portal.forgotPassword':          'Forgot login details?',
    'portal.forgotPasswordTitle':     'Forgot Login Details',
    'portal.forgotPasswordDesc':      'Enter your email address and we\'ll send you your username and a password reset code in one email.',
    'portal.emailLabel':              'Email address',
    'portal.sendCode':                'Send Login Details',
    ...
    'portal.phone':                   'Phone number (optional)',
  ...
  ar: {
    ...
    'portal.forgotPassword':          'نسيت بيانات الدخول؟',
    'portal.forgotPasswordTitle':     'استعادة بيانات الدخول',
    'portal.forgotPasswordDesc':      'أدخل بريدك الإلكتروني وسنرسل لك اسم المستخدم ورمز إعادة تعيين كلمة المرور في رسالة واحدة.',
    'portal.emailLabel':              'البريد الإلكتروني',
    'portal.sendCode':                'إرسال بيانات الدخول',
    ...
    'portal.phone':                   'رقم الهاتف (اختياري)',

...
const translations = {
  en: {
    ...
    'portal.forgotPasswordTitle':     'Reset your password',
    'portal.forgotPasswordDesc':      'Enter your email address and we\'ll send you a verification code.',
  ...
  ar: {
    ...
    'portal.forgotPassword':          'نسيت كلمة المرور؟',
    'portal.forgotPasswordTitle':     'إعادة تعيين كلمة المرور',
    'portal.forgotPasswordDesc':      'أدخل بريدك الإلكتروني وسنرسل لك رمز التحقق.',
    'portal.emailLabel':              'البريد الإلكتروني',
    'portal.sendCode':                'إرسال رمز التحقق',

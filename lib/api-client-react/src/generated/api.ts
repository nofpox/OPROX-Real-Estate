...
export const getListFieldUsersUrl = (params?: ListFieldUsersParams,) => {
  const normalizedParams = new URLSearchParams();
  ...
  return stringifiedParams.length > 0 ? `/api/field-users?${stringifiedParams}` : `/api/field-users`
}

/**
 * @summary List field operations users
 */
export const listFieldUsers = async (params?: ListFieldUsersParams, options?: RequestInit): Promise<FieldUser[]> => {

  return customFetch<FieldUser[]>(getListFieldUsersUrl(params),
  {
    ...options,
    method: 'GET'
...
export const getListFieldUsersQueryKey = (params?: ListFieldUsersParams,) => {
    return [
    `/api/field-users`, ...(params ? [params] : [])
    ] as const;
    }


export const getListFieldUsersQueryOptions = <TData = Awaited<ReturnType<typeof listFieldUsers>>, TError = ErrorType<unknown>>(params?: ListFieldUsersParams, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof listFieldUsers>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
) => {

const {query: queryOptions, request: requestOptions} = options ?? {};

  const queryKey =  queryOptions?.queryKey ?? getListFieldUsersQueryKey(params);



    const queryFn: QueryFunction<Awaited<ReturnType<typeof listFieldUsers>>> = ({ signal }) => listFieldUsers(params, { signal, ...requestOptions });





   return  { queryKey, queryFn, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof listFieldUsers>>, TError, TData> & { queryKey: QueryKey }
}

export type ListFieldUsersQueryResult = NonNullable<Awaited<ReturnType<typeof listFieldUsers>>>
export type ListFieldUsersQueryError = ErrorType<unknown>
...
export function useListFieldUsers<TData = Awaited<ReturnType<typeof listFieldUsers>>, TError = ErrorType<unknown>>(
 params?: ListFieldUsersParams, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof listFieldUsers>>, TError, TData>, request?: SecondParameter<typeof customFetch>}

 ):  UseQueryResult<TData, TError> & { queryKey: QueryKey } {

  const queryOptions = getListFieldUsersQueryOptions(params,options)
...
export const getCreateFieldUserUrl = () => {




  return `/api/field-users`
}

/**
 * @summary Create a field user
 */
export const createFieldUser = async (fieldUserInput: FieldUserInput, options?: RequestInit): Promise<FieldUser> => {

  return customFetch<FieldUser>(getCreateFieldUserUrl(),
  {
    ...options,
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
...
export const getCreateFieldUserMutationOptions = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof createFieldUser>>, TError,{data: BodyType<FieldUserInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof createFieldUser>>, TError,{data: BodyType<FieldUserInput>}, TContext> => {

const mutationKey = ['createFieldUser'];
const {mutation: mutationOptions, request: requestOptions} = options ?
      options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey ?
      options
      : {...options, mutation: {...options.mutation, mutationKey}}
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof createFieldUser>>, {data: BodyType<FieldUserInput>}> = (props) => {
          const {data} = props ?? {};

          return  createFieldUser(data,requestOptions)
        }
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type CreateFieldUserMutationResult = NonNullable<Awaited<ReturnType<typeof createFieldUser>>>
    export type CreateFieldUserMutationBody = BodyType<FieldUserInput>
    export type CreateFieldUserMutationError = ErrorType<unknown>

    /**
 * @summary Create a field user
 */
export const useCreateFieldUser = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof createFieldUser>>, TError,{data: BodyType<FieldUserInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
        Awaited<ReturnType<typeof createFieldUser>>,
        TError,
        {data: BodyType<FieldUserInput>},
        TContext
      > => {
      return useMutation(getCreateFieldUserMutationOptions(options));
    }

export const getUpdateFieldUserUrl = (id: number,) => {




  return `/api/field-users/${id}`
}

/**
 * @summary Update a field user
 */
export const updateFieldUser = async (id: number,
    fieldUserInput: FieldUserInput, options?: RequestInit): Promise<FieldUser> => {

  return customFetch<FieldUser>(getUpdateFieldUserUrl(id),
  {
    ...options,
    method: 'PATCH',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
...
export const getUpdateFieldUserMutationOptions = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof updateFieldUser>>, TError,{id: number;data: BodyType<FieldUserInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof updateFieldUser>>, TError,{id: number;data: BodyType<FieldUserInput>}, TContext> => {

const mutationKey = ['updateFieldUser'];
const {mutation: mutationOptions, request: requestOptions} = options ?
      options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey ?
      options
      : {...options, mutation: {...options.mutation, mutationKey}}
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof updateFieldUser>>, {id: number;data: BodyType<FieldUserInput>}> = (props) => {
          const {id,data} = props ?? {};

          return  updateFieldUser(id,data,requestOptions)
        }
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type UpdateFieldUserMutationResult = NonNullable<Awaited<ReturnType<typeof updateFieldUser>>>
    export type UpdateFieldUserMutationBody = BodyType<FieldUserInput>
    export type UpdateFieldUserMutationError = ErrorType<unknown>

    /**
 * @summary Update a field user
 */
export const useUpdateFieldUser = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof updateFieldUser>>, TError,{id: number;data: BodyType<FieldUserInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
        Awaited<ReturnType<typeof updateFieldUser>>,
        TError,
        {id: number;data: BodyType<FieldUserInput>},
        TContext
      > => {
      return useMutation(getUpdateFieldUserMutationOptions(options));
    }

export const getDeleteFieldUserUrl = (id: number,) => {
 ...
 */
export const deleteFieldUser = async (id: number, options?: RequestInit): Promise<void> => {

  return customFetch<void>(getDeleteFieldUserUrl(id),
  {
    ...options,
    method: 'DELETE'
...
export const getDeleteFieldUserMutationOptions = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof deleteFieldUser>>, TError,{id: number}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof deleteFieldUser>>, TError,{id: number}, TContext> => {

const mutationKey = ['deleteFieldUser'];
const {mutation: mutationOptions, request: requestOptions} = options ?
      options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey ?
      options
      : {...options, mutation: {...options.mutation, mutationKey}}
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof deleteFieldUser>>, {id: number}> = (props) => {
          const {id} = props ?? {};

          return  deleteFieldUser(id,requestOptions)
        }
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type DeleteFieldUserMutationResult = NonNullable<Awaited<ReturnType<typeof deleteFieldUser>>>

    export type DeleteFieldUserMutationError = ErrorType<unknown>

    /**
 * @summary Delete a field user
 */
export const useDeleteFieldUser = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof deleteFieldUser>>, TError,{id: number}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
        Awaited<ReturnType<typeof deleteFieldUser>>,
        TError,
        {id: number},
        TContext
      > => {
